...
<body>
	...
	<div id="container" class="container-fluid">
		...
		<div id="top" class="row">
			...
			<div class="col-md-6">
				<div class="input-group h2">
					<input name="data[search]" class="form-control" id="search"
						type="text" placeholder="Pesquisar posts"> <span
			...
			<div class="col-md-3">
				<a href="/crud-manager/post/form"
					class="btn btn-danger pull-right h2"><span
					class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Post</a>
			</div>
		</div>
						...
						<c:forEach var="post" items="${posts}">
							<tr>
								...
								<td class="actions"><a
									...
									post-id="${post.getId()}" post-content="${post.getContent()}"
